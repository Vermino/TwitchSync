...
describe('Tasks API Integration Tests', () => {
  ...
  describe('updateTask API endpoint', () => {
    ...
    test('should forward update payloads because validation happens in route middleware', async () => {
      const updateData = {
  ...
  describe('manualRunTask API endpoint', () => {
    test('should successfully start Rimworld/disnof task manually', async () => {
      ...
      mockOperations.toggleTaskState.mockResolvedValue(runningTask as any);
      mockRequest.params = { id: '1' };
  ...
  describe('batchUpdateTasks API endpoint', () => {
    ...
    test('should forward batch payloads because validation happens in route middleware', async () => {
      const batchUpdateData = {
        task_ids: [1, 2, 3],
        updates: {
      ...
      mockOperations.batchUpdateTasks.mockResolvedValue([] as any);
      mockRequest.body = batchUpdateData;
