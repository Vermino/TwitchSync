      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        <div className="space-y-2">
          ...
          <Input
            ...
            data-testid="task-min-followers-input"
          />
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            data-testid="task-min-views-input"
          />
          <p className="text-sm text-muted-foreground">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            data-testid="task-min-duration-input"
          />
          <p className="text-sm text-muted-foreground">
        ...
        <div className="space-y-2">
          ...
          >
            <SelectTrigger data-testid="task-languages-trigger">
