    ...
    <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
      <div className="space-y-4">
        <div className="space-y-2">
          ...
          >
            <SelectTrigger data-testid="task-schedule-type-trigger">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            data-testid="task-schedule-value-input"
          />
        ...
        <div className="space-y-2">
          ...
          >
            <SelectTrigger data-testid="task-priority-trigger">
      ...
      <div className="space-y-4">
        <div className="space-y-2">
          ...
          >
            <SelectTrigger data-testid="task-quality-trigger">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            min="0"
            data-testid="task-storage-limit-input"
          />
          <p className="text-sm text-muted-foreground">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            min="1"
            max="365"
            data-testid="task-retention-days-input"
          />
          <p className="text-sm text-muted-foreground">
        ...
        <div className="space-y-2">
          <Label className="flex items-center gap-2">
            <input
              ...
              data-testid="task-auto-delete-checkbox"
