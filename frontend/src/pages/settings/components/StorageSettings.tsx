      ...
      <div className="space-y-6">
        <div>
          ...
          <input
            ...
            data-testid="settings-disk-space-alert-threshold"
        ...
        <div className="flex items-center gap-3">
          <input
            ...
            data-testid="settings-enable-auto-cleanup"
        ...
        <div>
          ...
          <input
            ...
            data-testid="settings-cleanup-threshold-gb"
            onChange={(e) => onSettingsChange({
              ...settings,
        ...
        <div>
          ...
          <input
            ...
            data-testid="settings-min-age-for-cleanup-days"
            onChange={(e) => onSettingsChange({
              ...settings,
        ...
        <div className="flex items-center gap-3">
          <input
            type="checkbox"
            id="keepMetadata"
            data-testid="settings-keep-metadata-on-cleanup"
        ...
        <div className="pt-4 border-t">
          <button
            ...
            disabled={!settings.enableAutoCleanup}
            data-testid="settings-run-cleanup-button"
