      ...
      <div className="space-y-6">
        <div>
          ...
          <input
            ...
            data-testid="settings-filename-template"
        ...
        <div>
          ...
          <select
            ...
            data-testid="settings-folder-structure"
            onChange={(e) => onSettingsChange({
              ...settings,
        ...
        <div className="flex items-center gap-3">
          <input
            type="checkbox"
            id="createDateBasedFolders"
            data-testid="settings-create-date-folders"
            checked={settings.createDateBasedFolders}
            onChange={(e) => onSettingsChange({
              ...settings,
              createDateBasedFolders: e.target.checked
            })}
            className="rounded border-gray-300"
          />
          <label htmlFor="createDateBasedFolders">
        ...
        <div className="flex items-center gap-3">
          <input
            ...
            data-testid="settings-create-channel-folders"
        ...
        <div className="flex items-center gap-3">
          <input
            ...
            data-testid="settings-create-game-folders"
        ...
        <div>
          ...
          <select
            ...
            data-testid="settings-metadata-format"
            onChange={(e) => onSettingsChange({
              ...settings,
