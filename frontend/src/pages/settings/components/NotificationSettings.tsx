      ...
      <div className="space-y-6">
        <div>
          <div className="flex items-center gap-3 mb-3">
            <input
              ...
              data-testid="settings-enable-email-notifications"
          ...
          {settings.enableEmailNotifications && (
            <input
              ...
              data-testid="settings-email-address"
              onChange={(e) => onSettingsChange({
                ...settings,
        ...
        <div className="flex items-center gap-3">
          <input
            ...
            data-testid="settings-enable-desktop-notifications"
        ...
        <div>
          <div className="flex items-center gap-3 mb-3">
            <input
              ...
              data-testid="settings-enable-discord-webhook"
          ...
          {settings.enableDiscordWebhook && (
            <input
              ...
              data-testid="settings-discord-webhook-url"
              onChange={(e) => onSettingsChange({
                ...settings,
        ...
        <div className="space-y-3 pt-4 border-t">
          ...
          <div className="flex items-center gap-3">
            <input
              ...
              data-testid="settings-notify-on-download-start"
          ...
          <div className="flex items-center gap-3">
            <input
              ...
              data-testid="settings-notify-on-download-complete"
          ...
          <div className="flex items-center gap-3">
            <input
              ...
              data-testid="settings-notify-on-storage-alert"
